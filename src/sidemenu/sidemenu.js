        ...
        return(
            ...
            <div class="page-menu-inner" data-simplebar>
                <ul class="mt-0">
                    ...
                    <li><Link to="/coders/admin"><i class="uil-home-alt"></i> <span> Dashboard</span></Link> </li>
                    <li><Link to="/coders/catagories"><i class="uil-tag-alt"></i> <span> Catagories</span></Link> </li>
                    <li><Link to="/coders/course"><i class="uil-tag-alt"></i> <span> Courses</span></Link> </li>
